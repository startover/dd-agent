...
mkdir packaging\oneapm-ci-agent\win32\install_files\Microsoft.VC90.CRT

cp dist\*.* packaging\oneapm-ci-agent\win32\install_files\files
cp dist\Microsoft.VC90.CRT\* packaging\oneapm-ci-agent\win32\install_files\Microsoft.VC90.CRT\

# Change to the packaging directory
cd packaging\oneapm-ci-agent\win32
